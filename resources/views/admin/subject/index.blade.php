...
<div class="container">
    <div class="levels-section shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('admin.subject.create') }}" class="btn btn-add"> Add Subject</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('admin.subject.edit',$subject) }}" class="btn btn-sm btn-edit action-btn"> Edit</a>
                            <form action="{{ route('admin.subject.destroy',$subject) }}" method="POST" class="d-inline"
