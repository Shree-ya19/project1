...
<div class="container">
    <div class="form-section shadow-sm">
        <h2 class="form-title">Edit Level</h2>
        ...
        <form action="{{ route('admin.level.update', $level) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control" value="{{ old('slug', $level->slug) }}" required>
            </div>

            <div class="mb-3">
                <label for="position" class="form-label">Position</label>
                <input type="text" name="position" class="form-control" value="{{ old('position', $level->position) }}">
            </div>
            ...
            <div class="mb-3">
                    ...
                    <select class="form-select" name="level_id" id="level_id" aria-label="Floating label select example">
                        ...
                        <option value="{{ $level->id }}"{{ old('level_id',$level->level_id) == $level->id ? 'selected':'' }}>{{ $level->title }}</option>
                         @endforeach
                    </select>
                </div>
                <div class="mb-3">
            ...
            <button type="submit" class="btn btn-submit" style="background-color: #00440b; color: #e7d31f; border-color: #00440b;">Update Level</button>
